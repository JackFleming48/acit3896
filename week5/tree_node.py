class TreeNode:
    ...
    def dfs(self):
        ...
        # returns a list of contents in the order visited
        out = []
...
def case1():
    ...
    # dfs prints
    print("dfs of root (should visit A, B, C, D):", root.dfs())
...
def case3():
    ...
    # dfs prints
    print("dfs of root (one valid DFS order is A, B, E, C, D, F, G):", root.dfs())
    print("dfs of D (should visit D, F, G):", d.dfs())
